...
public class VideoGameRentalTest extends TestCase{
    ...
    public void testGetDaysRented() {
        ...
        VideoGameRental instance = new VideoGameRental(littleBigPlanet,2,true);
        int expResult = littleBigPlanet.getFrequentRenterPoints(2, true);
    ...
    public void testGetVideoGame() {
        ...
        VideoGameRental instance = new VideoGameRental(fable2,2,true);
    ...
    public void testGetCharge() {
        ...
        VideoGameRental instance = new VideoGameRental(superSmashBrosBrawl,2,true);
        double expResult = superSmashBrosBrawl.getCharge(2, true);
    ...
    public void testGetFrequentRenterPoints() {
        ...
        VideoGameRental instance = new VideoGameRental(superSmashBrosBrawl,2,true);
        int expResult = superSmashBrosBrawl.getFrequentRenterPoints(2, true);
